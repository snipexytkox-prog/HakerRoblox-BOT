...
class ZamowienieModal(ui.Modal):
    ...
    platnosc_select = ui.Select(
        ...
        options=[
            ...
            discord.SelectOption(label="PRZELEW ONLINE", description="Tradycyjny przelew online", emoji="🏦"),
            discord.SelectOption(label="PAYSAFEARD (+15%)", description="Płatność kartą PSC", emoji="🎫")
        ]
    )
